...
function preload() {
    var assets = {
        spritesheet: {
            birdie: ['assets/birdie.png', 24, 18],
...
function reset() {
    ...
    scoreText.setText("Las aventuras\nde Chispita");
    instText.setText("Toca para hacer\nsaltar a Chispita");
...
function setGameOver() {
    gameOver = true;
    instText.setText("Toca a Chispita\nPara intentar\nde nuevo");
